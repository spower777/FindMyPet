...
function LeafletMap({ pets, defaultCenter, defaultZoom, interactive }: Required<Props>) {
  // Dynamic import inside render — safe because this only runs client-side after mount
