  ...
  return (
    <html lang="pl" suppressHydrationWarning className={`${geist.variable} h-full`}>
      <head>
        ...
        />
        {/* Colour theme — prevent flash */}
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('fmp-theme');if(t&&t!=='natural')document.documentElement.setAttribute('data-theme',t)}catch(e){}})()`,
          }}
        />
